"""Add user_id to CaseHistory

Revision ID: 7cf626e3ed71
Revises: 
Create Date: 2024-08-07 14:12:46.985496
...
def upgrade():
    ...
    sa.Column('qualification_certificate', sa.String(length=256), nullable=True),
