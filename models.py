...
class User(db.Model, SerializerMixin):
    ...
    serialize_rules = (
        '-password', '-area_of_residence', '-id_no',
        '-payments.user', '-subscriptions.user', '-lawyer_details.user',
        '-reviews.user', '-messages_sent.sender', '-messages_received.receiver', '-cases.user'
    )
